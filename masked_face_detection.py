...
class masked_face_detection:
    ...
    def draw(self, frame, output_info):
        h,w = frame.shape[:2]
        ...
        for info in output_info:
            ...
            object["face_idx"] = str(idx_face)
            if idx_mask == 0:
                object["condition"] = 'Masked'
            else:
                object["condition"] = 'No Mask'


            frame = plot_cv.plot_object(frame, box, '', object["condition"], conf)
